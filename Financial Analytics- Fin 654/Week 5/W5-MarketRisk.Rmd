...
ggplot(zt.df, aes(x = Deviations, fill = Distribution)) + geom_density(alpha=.5)  +   geom_vline(aes(xintercept=z.threshold), color="red", linetype ="dashed", size=1) + geom_vline(aes(xintercept=t.threshold), color="blue", linetype="dashed", size=1) + xlim(-3,3)
```
