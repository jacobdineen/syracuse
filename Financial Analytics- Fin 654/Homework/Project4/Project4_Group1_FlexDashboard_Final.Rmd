...
As with any commodity, there is a commodity risk. Business performance may be negatively impacted by the fluctuation of the price. If there is a price drop, the company will receive less revenue. There could potentially be a quantity risk which would impact the availability of the product. If the product is not available then it can't be shipped or it may be delayed which is a result of the time lag between the order and receipt of goods. The stationarity of the returns of the three metals over the past 5 years would seemingly mitigate, over time, any potential losses due to temporal trends. It is of note, however, that of the three metals analyzed here, nickel appears to be the most volatile. 
...
The freight fowarder must decide if they should enter the tramp trade. This means they must have vessels and vessel operations personnel available on short notice.  They have allowed for a reserve of capital (250M) to meet the need of a last minute deployment of our shipping resources. 
The company should consider the following questions: 
   a) What is out exppected revenue/loss? 
   b) If a loss is generated, what is the potential frequency and severity? 
   c) What is the potential operational risk? 
   d) What events could happen to impact the shipments and prices? 
   e) Who are the domestic vs. international customers? 
   f) How can we efficently quote freight costs? If customers are mainly international, consider the international border laws and transport delays. Customs procedures can be extremely complicated and inconsistent from country to country. These procedures may need to addressed on an individual customer basis.
